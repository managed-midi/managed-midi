...
using delegate0 = ManagedMidi.AlsaSharp.Delegates.snd_async_callback_t; // global.h (121,16)
using delegate1 = ManagedMidi.AlsaSharp.Delegates.snd_lib_error_handler_t; // error.h (59,16)
//using delegate2 = ManagedMidi.AlsaSharp.Delegates.snd_local_error_handler_t; // error.h (78,16)
using delegate3 = ManagedMidi.AlsaSharp.Delegates.snd_pcm_hook_func_t; // pcm.h (1153,15)
using delegate6 = ManagedMidi.AlsaSharp.Delegates.snd_hctl_compare_t; // control.h (531,15)
using delegate7 = ManagedMidi.AlsaSharp.Delegates.snd_hctl_callback_t; // control.h (542,15)
using delegate8 = ManagedMidi.AlsaSharp.Delegates.snd_hctl_elem_callback_t; // control.h (551,15)
using delegate9 = ManagedMidi.AlsaSharp.Delegates.snd_mixer_callback_t; // mixer.h (55,15)
using delegate10 = ManagedMidi.AlsaSharp.Delegates.snd_mixer_elem_callback_t; // mixer.h (65,15)
using delegate11 = ManagedMidi.AlsaSharp.Delegates.snd_mixer_compare_t; // mixer.h (74,15)
using delegate12 = ManagedMidi.AlsaSharp.Delegates.snd_mixer_event_t; // mixer.h (85,15)
using snd_async_callback_t = ManagedMidi.AlsaSharp.Delegates.snd_async_callback_t;
using snd_lib_error_handler_t = ManagedMidi.AlsaSharp.Delegates.snd_lib_error_handler_t;
//using snd_local_error_handler_t = ManagedMidi.AlsaSharp.Delegates.snd_local_error_handler_t;
using snd_pcm_hook_func_t = ManagedMidi.AlsaSharp.Delegates.snd_pcm_hook_func_t;
using delegate4 = ManagedMidi.AlsaSharp.Delegates.delegate4;
using delegate5 = ManagedMidi.AlsaSharp.Delegates.delegate5;
using snd_hctl_compare_t = ManagedMidi.AlsaSharp.Delegates.snd_hctl_compare_t;
using snd_hctl_callback_t = ManagedMidi.AlsaSharp.Delegates.snd_hctl_callback_t;
using snd_hctl_elem_callback_t = ManagedMidi.AlsaSharp.Delegates.snd_hctl_elem_callback_t;
using snd_mixer_callback_t = ManagedMidi.AlsaSharp.Delegates.snd_mixer_callback_t;
using snd_mixer_elem_callback_t = ManagedMidi.AlsaSharp.Delegates.snd_mixer_elem_callback_t;
using snd_mixer_compare_t = ManagedMidi.AlsaSharp.Delegates.snd_mixer_compare_t;
using snd_mixer_event_t = ManagedMidi.AlsaSharp.Delegates.snd_mixer_event_t;
using delegate13 = ManagedMidi.AlsaSharp.Delegates.delegate13;
using delegate14 = ManagedMidi.AlsaSharp.Delegates.delegate14;
